...
import com.vms.server.domain.entity.aem.id.AemEquipmentPmDtlStatusId;
...
@IdClass(AemEquipmentPmDtlStatusId.class)
@Table(name = "AEM_EQUIPMENT_PM_DTL_STATUS")
public class AemEquipmentPmDtlStatus {
  @Id
  @Column(name = "PLANT")
  public String plant;
  @Id
