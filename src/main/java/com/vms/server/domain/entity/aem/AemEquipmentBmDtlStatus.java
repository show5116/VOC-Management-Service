...
import com.vms.server.domain.entity.aem.id.AemEquipmentBmDtlStatusId;
...
@IdClass(AemEquipmentBmDtlStatusId.class)
@Table(name = "AEM_EQUIPMENT_BM_DTL_STATUS")
public class AemEquipmentBmDtlStatus {
  @Id
  @Column(name = "PLANT")
  public String plant;
  @Id
