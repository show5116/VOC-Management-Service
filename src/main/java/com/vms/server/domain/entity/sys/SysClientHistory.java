...
import com.vms.server.domain.entity.sys.id.SysClientHistoryId;
...
@IdClass(SysClientHistoryId.class)
@Table(name = "SYS_CLIENT_HISTORY")
public class SysClientHistory {
  @Id
