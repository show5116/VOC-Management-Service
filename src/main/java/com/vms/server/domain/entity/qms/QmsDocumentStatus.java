...
import com.vms.server.domain.entity.qms.id.QmsDocumentStatusId;
...
@IdClass(QmsDocumentStatusId.class)
@Table(name = "QMS_DOCUMENT_STATUS")
public class QmsDocumentStatus {
  @Id
  @Column(name = "PLANT")
  public String plant;
  @Id
