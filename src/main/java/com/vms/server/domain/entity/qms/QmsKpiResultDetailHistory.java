...
import com.vms.server.domain.entity.qms.id.QmsKpiResultDetailHistoryId;
...
@IdClass(QmsKpiResultDetailHistoryId.class)
@Table(name = "QMS_KPI_RESULT_DETAIL_HISTORY")
public class QmsKpiResultDetailHistory {
  @Id
  @Column(name = "PLANT")
  public String plant;
  @Id
